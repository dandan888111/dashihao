        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.innerHTML = '<div class="area_ctrl slideInUp">' +
                    ...
                    '</div>' +
                    '</div>';
                document.querySelector('.dashi-content-mid-area').appendChild(_self.gearArea);
                areaCtrlInit();
                $('.dashi-content').on('click','.larea_finish',function(e) {
                    _self.finish(e);
                    let countryList = document.querySelector('#area_value').value.split(',')
                    console.log($('.area_province>div[ref="'+countryList[0]+'"]').html()+'-' + $('.area_city>div[ref="'+countryList[1]+'"]').html() +'-'+ $('.area_county>div[ref="'+countryList[2]+'"]').html())
                    config_birthPlace = $('.area_province>div[ref="'+countryList[0]+'"]').html()+'-' + $('.area_city>div[ref="'+countryList[1]+'"]').html() +'-'+ $('.area_county>div[ref="'+countryList[2]+'"]').html()
            ...
            _self.getData(function() {
                // _self.trigger.addEventListener('click', popupArea);  //点击调起（取消）
                popupArea()
            });
        },
        //重置节点个数
